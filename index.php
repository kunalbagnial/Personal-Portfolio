...
<head>
    ...
    <meta name="description" content="I am a web designer & developer based in Punjab. I design responsive and modern websites.">
    <title>Kunal Bagnial | Designer &amp; Developer</title>
    <link rel="canonical" href="https://devkunal.000webhostapp.com/">
    <!-- css and libraries -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio_img">
                        <img src="imgs/project-1.png" class="img-fluid">
                        <div class="hover">
                            <a href="#" target="_blank"><i class='lni lni-eye'></i></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio_img">
                        <img src="imgs/project-2.png" class="img-fluid">
                        <div class="hover">
                            <a href="#" target="_blank"><i class='lni lni-eye'></i></a>
                            <a href="#" target="_blank"><i class='lni lni-github-original'></i></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio_img">
                        <img src="imgs/project-3.png" class="img-fluid">
                        <div class="hover">
                            <a href="#" target="_blank"><i class='lni lni-eye'></i></a>
                            <a href="#" target="_blank"><i class='lni lni-github-original'></i></a>
                        </div>
